...
const NAV_ITEMS = [
  ...
  { href: '/radio', label: 'Rádio', icon: 'M9.19 4.389A.75.75 0 009 5.063v13.874a.75.75 0 001.502.316l2.754-10.526a.75.75 0 00-.712-.977H8.578a.75.75 0 00-.525.216L5.303 10.34a.75.75 0 00-.153.822l1.5 3.375a.75.75 0 001.344-.666L6.53 11.56l1.97-1.97z' },
